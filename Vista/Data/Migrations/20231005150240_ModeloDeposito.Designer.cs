...
namespace Vista.Data.Migrations
{
    ...
    [Migration("20231005150240_ModeloDeposito")]
    partial class ModeloDeposito
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vista.Data.Models.Salidas.Componentes.Deposito", b =>
                {
            ...
            modelBuilder.Entity("Vista.Data.Models.Salidas.Componentes.Material", b =>
                {
                    ...
                    b.HasIndex("MovimientoMId");

                    b.ToTable("Materiales");
                });

            modelBuilder.Entity("Vista.Data.Models.Salidas.Componentes.MovimientoM", b =>
                {
                    b.Property<int>("MovimientoMId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vista.Data.Models.Salidas.Componentes.Material", b =>
                {
                    b.HasOne("Vista.Data.Models.Salidas.Componentes.Deposito", null)
                        .WithMany("Materiales")
                        .HasForeignKey("DepositoId");

                    b.HasOne("Vista.Data.Models.Salidas.Componentes.MovimientoM", null)
                        .WithMany("Materiales")
                        .HasForeignKey("MovimientoMId");
                });

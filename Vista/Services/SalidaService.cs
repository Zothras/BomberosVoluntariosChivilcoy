...
namespace Vista.Services
{
    public interface ISalidaService
    {
        ...
        Task<MaterialPeligroso> CargarMaterialesPeligrosos<T>(T entidad) where T : MaterialPeligroso;
    ...
    public class SalidaService : ISalidaService
    {
        ...
        public async Task<MaterialPeligroso> CargarMaterialesPeligrosos<T>(T salida) where T : MaterialPeligroso 
        {
            try
            {
                Bombero? bomberoEncargado = await _context.Bomberos.Where(b => b.NumeroLegajo == salida.Encargado.NumeroLegajo).SingleOrDefaultAsync();
            ...
            {
                Console.WriteLine($"ERROR: Error al cargar la Salida de Materiales Peligrosos. {ex.Message}");
                throw;
            }
            catch (Exception ex)
            {
